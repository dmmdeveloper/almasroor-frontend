...
<Link  target='_blank' to={"tel:+923193291955"} className='font-bold md:text-xl text-[17px] hover:opacity-85 underline decoration-appYellow duration-200' > <i class="fa-solid fa-location-arrow"></i> almasroor</Link>
...
<Link  target='_blank' to={"mailto:sd@gmial.com"} className='font-bold md:text-xl text-[17px] hover:opacity-85 underline decoration-appYellow duration-200' >almasroor@gmail.com</Link>
